...
define open class <shape> (<persistent>)
  ...
  slot responder :: false-or (<shape>) = #f, setter: %responder-setter;
  ...
  slot line-width = 3.0;
  slot effects :: <vector> = #[];
  slot reshape-mode = #[#"none", #"none"], init-keyword: reshape:;
...
define method responder-setter (value :: <shape>, shape :: <shape>)
