...
define method on-mouse-event
    (button :: <push-button>, event :: <mouse-enter-event>,
...
define method on-mouse-event
    (button :: <push-button>, event :: <mouse-exit-event>,
     mouse-button :: <mouse-button>)
 => ()
...
define method on-mouse-event
    (button :: <push-button>, event :: <mouse-up-event>,
     mouse-button :: <mouse-button>)
 => ()
  block ()
    button.on-click (button);
  exception (<error>)
    format-out ("button.on-click not defined\n");
  end;
  next-method ();
  glutPostRedisplay ();
end;
