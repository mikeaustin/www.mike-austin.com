...
// A <widget> is a shape that more closely resembles a standard control, such as
// a button, window or scroll-bar.

define open class <widget> (<rectangle>)
  inherited slot fill-color = vector (0.95, 0.95, 0.95, 1.0);
  inherited slot line-color = vector (0.75, 0.75, 0.75, 0.5);
...
define method set-model (widget :: <widget>, model :: <model>)
  widget.widget-model := model;
end;
