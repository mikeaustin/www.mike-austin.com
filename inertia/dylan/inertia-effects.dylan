...
define method draw-effect (shape :: <shape>, effect :: <gradient-effect>)
  let width = shape.shape-width;
  let height = shape.shape-height;
  glBegin ($GL-QUADS);
    glColor (1.0, 1.0, 1.0, 0.6); glVertex (  0.0,          0.0, 0.0);
    glColor (1.0, 1.0, 1.0, 0.0); glVertex (  0.0, height / 2.0, 0.0);
    glColor (1.0, 1.0, 1.0, 0.0); glVertex (width, height / 2.0, 0.0);
    glColor (1.0, 1.0, 1.0, 0.6); glVertex (width,          0.0, 0.0);

    glColor (0.0, 0.0, 0.0, 0.0);  glVertex (  0.0, height / 2.0, 0.0);
    glColor (0.0, 0.0, 0.0, 0.05); glVertex (  0.0,       height, 0.0);
    glColor (0.0, 0.0, 0.0, 0.05); glVertex (width,       height, 0.0);
    glColor (0.0, 0.0, 0.0, 0.0);  glVertex (width, height / 2.0, 0.0);
  glEnd ();
end;
