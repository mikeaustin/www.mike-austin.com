...
var a=require("_rpc");
return{extend:a.extend,init:a.init,uiParams:require("_ui-params"),create:require("host/create"),_uriHelper:require("_uri"),_statusHelper:require("host/_status_helper"),_addons:require("host/_addons"),webItemHelper:require("host/content"),version:"3.2.8"}
}));
}catch(e){WRMCB(e)};
;
try {
...
(function(b,a){b("ac/scrollPosition",["connect-host"],function(d){var c={getPosition:function(){if(this.uiParams.isGeneral){var f=this.iframe.getBoundingClientRect();
var g=f.top+document.body.scrollTop;
var e=f.left+document.body.scrollLeft;
return{scrollY:window.scrollY-g,scrollX:window.scrollX-e,width:window.innerWidth,height:window.innerHeight}
}else{a.log("ScrollPosition is only available to page modules")
}}};
d.extend(function(){return{internals:c}
});
return c
})
})(define,AJS);
