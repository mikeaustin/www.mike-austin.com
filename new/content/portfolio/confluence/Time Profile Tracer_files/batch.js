...
var AJS=require("ajs");
(function(d){AJS.moreLinkClickHandler=function(e){var c=d(this),f=c.attr("href"),b=c.closest(".more-link-container");if(!b.length)throw Error("Could not find more link container when one was expected.");b.addClass("loading");d.get(f,function(a){var a=d(a).wrap("<div/>").parent(),c=a.children("ul").children("li");b.closest(".results-container").children("ul").append(c);a=a.find(".more-link-container");0===a.length?b.remove():b.replaceWith(a);AJS.PageGadget&&AJS.PageGadget.contentsUpdated&&AJS.PageGadget.contentsUpdated()});
return AJS.stopEvent(e)}})(AJS.$);
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'confluence.macros.advanced:get-more', location = 'com/atlassian/confluence/plugins/macros/advanced/js/get-more.js' */
var AJS=require("ajs");AJS.toInit(function(a){a(".results-container").on("click",".more-link",AJS.moreLinkClickHandler)});
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'confluence.macros.advanced:get-more', location = 'com/atlassian/confluence/plugins/macros/advanced/js/filter-control.js' */
var AJS=require("ajs");AJS.toInit(function(a){a("select.content-filter").change(function(){a(".filter-control .waiting-image").removeClass("hidden");var d=a(this);a.get(AJS.params.changesUrl,{contentType:a(this).val()},function(b){var b=a(b),c=d.parent();c.parent().siblings(".results-container").children("ul").html(b);a(".waiting-image",c).addClass("hidden");a(".more-link",b).click(AJS.moreLinkClickHandler)})})});
}catch(e){WRMCB(e)};
;
try {
