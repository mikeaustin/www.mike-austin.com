...
<!-- body_text //-->
    <td width="100%" class="col_center"><?php echo tep_draw_form('create_account', tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL'), 'post', 'onSubmit="return check_form(create_account);"') . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td>
...
<? tep_draw_heading_top_1();?>
     ...
     <table cellpadding="0" cellspacing="0" border="0"> <tr><td class="smallText padd_1"><br><?php echo sprintf(TEXT_ORIGIN_LOGIN, tep_href_link(FILENAME_LOGIN, tep_get_all_get_params(), 'SSL')); ?></td></tr></table>
