//
// SoftBody.io - 2004 Mike Austin
//

time := 0

SoftBody := Object clone appendProto( OpenGL ) do (
...
Mass := Object clone appendProto( OpenGL ) do (
  ...
  init := method (
    self position := Point clone set( (Random value - .5) * 400, (Random value - .5) * 300 )
    self velocity := Point clone set( Random value - .5, Random value - .5 )
    //write( velocity, "\n" )
...
Spring := Object clone appendProto( OpenGL ) do (
  ...
  connectMasses := method ( mass1, mass2, distance,
    ...
    mass1 springs append( self )
    mass2 springs append( self )
    SoftBody addObject( self )
  )
...
SoftBody addObject( mass1 )
SoftBody addObject( mass2 )
SoftBody addObject( mass3 )
SoftBody addObject( mass4 )
SoftBody addObject( mass5 )
SoftBody addObject( mass6 )
